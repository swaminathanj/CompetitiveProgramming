...
The table below provides the complete details of experiments carried out for design pattern detection based on our approach. Please visit the [JHotDraw Case Study](JHotDraw Case Study) for the results of large open source case study.
